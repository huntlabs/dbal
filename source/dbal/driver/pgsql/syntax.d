module dbal.driver.pgsql.syntax;
...
class PgSqlSyntax : SqlSyntax
{
	...
	string setExpr()
	{
		...
		if(_builder.values.length){
			...
			throw new DbalException("query builder update method have not set values");
		}
		return set;
	}
	...
	override string toString()
	{
		if(!_builder.tableName.length)
			throw new DbalException("query build table name not exists");
		string str;
